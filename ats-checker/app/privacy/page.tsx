...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for ATS Resume Checker. Learn how we collect, use, and protect your resume data and personal information.",
  alternates: {
    canonical: "https://ats-checker-lake.vercel.app/privacy",
  },
      ...
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-2xl border p-8 space-y-6">
          ...
          <p className="text-gray-600">
            This Privacy Policy describes how ATS Resume Checker ("we", "us", or "our") collects,
            uses, and protects information when you use our website and services. By using our
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-600 text-sm">
              <li>
                ...
                is sent to our AI processing service to generate your ATS score and analysis. This
                content is processed transiently and is not stored on our servers after your
                session ends.
              </li>
              <li>
              ...
              <li>
                <strong>Payment information</strong> — If you purchase the resume optimization,
                your payment is processed securely by Stripe. We never see or store your credit
                card details.
              </li>
              <li>
                <strong>Browser storage</strong> — We use localStorage to temporarily cache your
                analysis results within your browser so you can navigate back to them. This data
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-600 text-sm">
              <li>To analyze your resume against the job description and generate an ATS score</li>
              <li>To produce keyword match reports and optimization suggestions</li>
              <li>To rewrite and optimize your resume if you purchase that service</li>
          ...
          <div>
            ...
            <p className="text-gray-600">
              We do not persistently store your resume text or job description on our servers.
              Your resume data is processed in memory to generate results and is discarded
              immediately after. Analysis results are cached in your own browser's localStorage
              and remain under your control. You can clear this data at any time by clearing your
              browser storage.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 space-y-2 text-gray-600 text-sm">
              <li>
                <strong>Anthropic (Claude AI)</strong> — Your resume and job description text
                is sent to Anthropic's Claude API to generate your analysis. Anthropic processes
              ...
              <li>
                <strong>Google Analytics / Vercel Analytics</strong> — Anonymized usage analytics
                to help us understand how the site is being used. No personally identifiable
          ...
          <div>
            ...
            <p className="text-gray-600">
              We take the security of your data seriously. All data transmitted between your
              browser and our servers is encrypted using industry-standard TLS/HTTPS. We do not
              store sensitive personal information, and all payment processing is delegated to
              PCI-compliant third-party providers. While no method of transmission over the
              internet is 100% secure, we implement commercially reasonable safeguards to protect
              your information.
            </p>
          </div>
